...
public class App {
    ...
    public static void altaProductos(Almacen almacen) {
        String[] lineasAltas = ManejadorArchivosGenerico.leerArchivo("ut3-listas-pilas-y-colas-aed2025-equipo11\\altas.txt");
    ...
    public static void ventaProdcutos(Almacen almacen) {
        String[] lineasAltas = ManejadorArchivosGenerico.leerArchivo("ut3-listas-pilas-y-colas-aed2025-equipo11\\ventas.txt");
        String[] datosProducto = new String[4];
        Integer total = 0;
        Integer vendido;
        for (int i = 0; i < lineasAltas.length; i++) {
